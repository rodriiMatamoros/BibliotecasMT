...
### Mi repositorio es: https://github.com/rodriiMatamoros/BibliotecasMT.git
...
```
java -Dspring.profiles.active=production -jar ./target/BibliotecasMT-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/bibliotecas-m-t
```
